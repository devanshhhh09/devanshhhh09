...
🏛️ **Software Engineering Intern** · Gurugram Police Cyber Crime Cell (GPCSSI 2026)

🔐 **Cyber Crime Intern** · UP Police / MHA – I4C, Lucknow

📍 **Lucknow, India** · Open to Relocate
...
Software Engineer with proven experience architecting and developing **distributed systems for production environments**. Built **PoliceOSINT** — an AI-powered investigation platform for Gurugram Police — leveraging asynchronous task queues (Celery/Redis), concurrent scraping pipelines (50+ sources), and generative AI (Groq/Llama-3.3-70b).

```
🔭 Currently building  →  PoliceOSINT v1.0 — AI cyber investigation platform (Gurugram Police)
🌱 Currently learning  →  Advanced Graphs, Dynamic Programming, System Design
💬 DSA language        →  C++ (primary) · Python (systems)
⚡ Fun fact            →  My code helped real law enforcement investigate cyber fraud
```
...
**🏛️ Software Engineering Intern** · Gurugram Police Cyber Crime Cell (GPCSSI)
`June 2026 · 4 Weeks`
- Architected PoliceOSINT v1.0 — reduced manual evidence triage by **~70%**
- 55/55 unit tests · 10+ OSINT modules · Full-stack production deployment

**🔐 Cyber Crime Intern** · UP Police / MHA – I4C, Lucknow
`January 2026 – February 2026 · 5 Weeks`
- Analyzed **50+ real cyber fraud cases** — phishing, UPI scams, investment fraud
- Built Python automation reducing pattern-detection time by **~30%**
...
![Contribution Graph](https://github-readme-activity-graph.vercel.app/graph?username=devanshhhh09&bg_color=0d1117&color=4285f4&line=34a853&point=fbbc05&area=true&hide_border=true)
...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/devanshhhh09)
